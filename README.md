...
#Test Simulation Arduino Nano in Proteus ISIS with Simulino
Library with boards Arduino 

Test blink in Proteus ISIS

#Simulation Proteus Isis
![Portada](https://github.com/JhonControl/Simulino-Arduino-Proteus--ISIS-/blob/master/simuled.JPG)
